...
class ResConfigSettings(models.TransientModel):
	...
	def get_values(self):
		...
		res.update({
			'overdue_days':int(self.env['ir.config_parameter'].sudo().get_param('insabhi_due_statement.overdue_days')) or None,
			'statement_days':int(self.env['ir.config_parameter'].sudo().get_param('insabhi_due_statement.statement_days')) or None,
			'auto_weekly_statement':self.env['ir.config_parameter'].sudo().get_param('insabhi_due_statement.auto_weekly_statement'),
			'auto_monthly_statement':self.env['ir.config_parameter'].sudo().get_param('insabhi_due_statement.auto_monthly_statement'),
			'send_statement':self.env['ir.config_parameter'].sudo().get_param('insabhi_due_statement.send_statement'),
			'send_overdue_statement':self.env['ir.config_parameter'].sudo().get_param('insabhi_due_statement.send_overdue_statement'),
			'weekly_template_id':int(self.env['ir.config_parameter'].sudo().get_param('insabhi_due_statement.weekly_template_id')) or None,
			'monthly_template_id':int(self.env['ir.config_parameter'].sudo().get_param('insabhi_due_statement.monthly_template_id')) or None,
			'overdue_statement_template_id':int(self.env['ir.config_parameter'].sudo().get_param('insabhi_due_statement.overdue_statement_template_id')) or None,
			'weekly_days':self.env['ir.config_parameter'].sudo().get_param('insabhi_due_statement.weekly_days') or None,
	...
	def set_values(self):
		...
		ICPSudo.set_param('insabhi_due_statement.send_statement',self.send_statement)
		ICPSudo.set_param('insabhi_due_statement.send_overdue_statement',self.send_overdue_statement)
		ICPSudo.set_param('insabhi_due_statement.statement_days',self.statement_days or None)
		ICPSudo.set_param('insabhi_due_statement.overdue_days',self.overdue_days or None)
		ICPSudo.set_param('insabhi_due_statement.weekly_days',self.weekly_days or None)
		ICPSudo.set_param('insabhi_due_statement.auto_monthly_statement',self.auto_monthly_statement)
		ICPSudo.set_param('insabhi_due_statement.auto_weekly_statement',self.auto_weekly_statement)
		ICPSudo.set_param('insabhi_due_statement.weekly_template_id',self.weekly_template_id.id or None)
		ICPSudo.set_param('insabhi_due_statement.monthly_template_id',self.monthly_template_id.id or None)
		ICPSudo.set_param('insabhi_due_statement.overdue_statement_template_id',self.overdue_statement_template_id.id or None)


		if self.send_overdue_statement:
			overdue_cron = self.env.ref('insabhi_due_statement.autometic_send_overdue_statement_cron')
		...
		if self.send_statement:
			if self.auto_monthly_statement:
				statement_cron = self.env.ref('insabhi_due_statement.autometic_send_monthly_statement_cron')
